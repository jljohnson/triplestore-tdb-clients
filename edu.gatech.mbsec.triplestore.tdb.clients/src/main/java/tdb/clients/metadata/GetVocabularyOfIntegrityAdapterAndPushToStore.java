...
public class GetVocabularyOfIntegrityAdapterAndPushToStore {
	...
	public static void main(String[] args) {
		...
		Thread thread = new Thread() {
			public void start() {
				...
				URI vocabURI = URI.create("http://localhost:8484/oslc4jintegrity/services/rdfvocabulary"); 
...
//				}
		...
		try {
			thread.join();
			System.out.println("Vocabulary of OSLC Integrity adapter added to triplestore");
