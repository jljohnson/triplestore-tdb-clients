...
public class GetVocabularyOfAMESimAdapterAndPushToStore {
	...
	public static void main(String[] args) {
		...
		Thread thread = new Thread() {
			public void start() {
				...
				URI vocabURI = URI.create("http://localhost:8282/oslc4jamesim/services/rdfvocabulary"); 
...
//				}
		...
		try {
			thread.join();
			System.out.println("Vocabulary of OSLC AMESim adapter added to triplestore");
