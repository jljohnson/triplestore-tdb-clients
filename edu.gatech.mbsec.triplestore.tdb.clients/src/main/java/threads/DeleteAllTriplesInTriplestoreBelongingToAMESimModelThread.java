...
public class DeleteAllTriplesInTriplestoreBelongingToAMESimModelThread extends Thread{

	String fileName;
	
	public DeleteAllTriplesInTriplestoreBelongingToAMESimModelThread(String fileName){
