...
public class DeleteAllTriplesInTriplestoreBelongingToModelThread extends Thread{

	String fileName;
	
	public DeleteAllTriplesInTriplestoreBelongingToModelThread(String fileName){
